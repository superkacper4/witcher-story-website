    ...
    return (
      ...
      >
        <div className={styles.text}>
          <h2>Meet Dandelion</h2>
          <p>
            Julian Alfred Pankratz, Viscount de Lettenhove, better known as
            Dandelion, was a poet, minstrel, bard, and close friend of Geralt of
            Rivia. He will be our guide in witcher's story
          </p>
        </div>
